...
UPDATE:::::
I'd generated an textual report using ChAT gpt 4-0. Gave her the csv file along with some clinical tests and you can check the report she'd generated by checking the adani filtered with reports.csv file.

Additionally, see the adni1 anlysis jupyter notebook and see from the comment - LLm generated report. 
