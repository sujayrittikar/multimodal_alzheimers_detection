...
UPDATE:::::
I'd generated an textual report using CGAT gpt 4-0. Gave her the csv file along with some clinical tests and you can check the report she'd generated by checking the adani filtered with reports.csv file
